...
let walletTransactions = [
    {
        id: 'txn-1',
        userId: 1,
        type: 'deposit', // deposit, withdrawal, payment
        amount: 100.00,
        balanceAfter: 250.50,
    ...
    },
    {
        ...
        amount: -25.00,
        balanceAfter: 225.50,
        description: 'Yemekhane - Öğle Yemeği',
    ...
    },
    {
        ...
        amount: -15.00,
        balanceAfter: 260.50,
        description: 'Kantin - Atıştırmalık',
        paymentMethod: 'wallet',
        status: 'completed',
    ...
    },
    {
        ...
        amount: -30.00,
        balanceAfter: 430.50,
        description: 'Yemekhane - Akşam Yemeği',
        paymentMethod: 'wallet',
        status: 'completed',
...
export function createMockDeposit(data) {
    ...
    const transaction = {
        ...
        description: getPaymentMethodName(paymentMethod) + ' ile Yükleme',
