...
import { ClipboardCheck, BookOpen, Users, Calendar, ArrowRight, Loader2 } from 'lucide-react';
...
/**
 * Attendance Reports List Page
 * Yoklama raporları listesi - öğretim üyesi için
 */
export default function AttendanceReportsListPage() {
        ...
        <div className="space-y-6">
            ...
            >
                ...
                <p className="text-muted-foreground mt-2">
                    Dersleriniz için yoklama raporlarını görüntüleyin
                </p>
            </motion.div>
            ...
            {sections.length === 0 ? (
                ...
                >
                    <ClipboardCheck className="size-16 mx-auto text-muted-foreground mb-4 opacity-50" />
                    ...
                    {sections.map((section, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Action Button */}
                                <Link href={`/attendance/report/${section.id}`}>
